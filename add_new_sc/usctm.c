...
#include "../my_system_calls/new_system_call.h"
// ++++++++++++++++++++++++++++++++++++++++++++
...
#endif
	return get_data(offset, destination, size);
}
...
int init_module(void) {
	...
	// +++++++++++++++++++++++++++++++++++
	printk("%s: sys_call has been installed on the sys_call_table at displacement: %d \n", MODNAME, FIRST_NI_SYSCALL);
	...
	// +++++++++++++++++++++++++++++++++++
	// set the block [2] - bit_map
	populate_bit_map(BLOCK_NUMBER_BIT_MAP);

	// set the block [0] - super_block
	set_bit_in_bit_map(0, BIT_SET);

	// set the block [1] - i_node
	set_bit_in_bit_map(1, BIT_SET);
	// +++++++++++++++++++++++++++++++++++
